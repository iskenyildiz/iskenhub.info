...
## HAPROXY
 ...
 But simply, a layer 4 load balancer determines the routing decisions based on the TCP headers whereas Layer 7 load balancer routes depending on the characteristics of the HTTP headers.
